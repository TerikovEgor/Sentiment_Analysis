...
model = load_model('src/muse_sent_v2.h5',custom_objects={'KerasLayer':hub.KerasLayer})
model.load_weights('src/muse_sent_w_v2.h5')
sw = open('src/sw_short.txt').read().split('\n')
